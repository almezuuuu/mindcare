              ...
              <form>
                <div class="card-body">
                  <div class="form-group-sm">
                    ...
                    <input type="text" class="form-control" id="fName" placeholder="<?=@$student_prof->fname?>">
                    <label for="mName">Middle Name</label>
                    <input type="text" class="form-control" id="mName" placeholder="<?=@$student_prof->mname?>">
                    <label for="lName">Last Name</label>
                    <input type="text" class="form-control" id="lName" placeholder="<?=@$student_prof->lname?>">
                  </div>
                  <div class="form-group-sm mt-2">
                    <label for="cNum">Contact Number</label>
                    <input type="text" class="form-control" id="cNum" placeholder="<?=@$student_prof->cnum?>">
                    <label for="email">Email Address</label>
                    <input type="text" class="form-control" id="email" placeholder="<?=@$student_prof->email?>">
                  </div>
                </div>
                <!-- /.card-body -->
