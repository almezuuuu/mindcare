...
<body>
  <section>
          ...
          <tbody>
            ...
            <tr data-widget="expandable-table" aria-expanded="false">
              ...
              <td class="col-4 pt-2 pl-4" style="padding:0%">
                <button class="btn btn-success p-1" type="button" data-toggle="modal" data-target="#modal_approve_remark"><i class="fa fa-check-circle" style="margin:0%;padding:0%"></i></button>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <input type="text" id="Remarks" class="col-12">
                        </div>
                        <div class="modal-footer justify-content-between">
                            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                            <button type="button" class="btn btn-default btn-success btnCancelC" id="btnCancelC" data-dismiss="modal">Submit</button>
                        </div>
                    </div>
                    <!-- /.modal-content -->
                </div>
    ...
    <!-- /.modal -->
            ...
            <div class="modal fade" id="modal_approve_remark">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                        <input type="hidden" name="appointmentIDC[]" class="appointmentIDC" value=<?= @$value->aptID ?>>
                        ...
                        <div class="modal-footer justify-content-between">
                            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                            <button type="button" class="btn btn-default btn-success btnApproveC" id="btnApproveC" data-dismiss="modal">Submit</button>
                        </div>
                    </div>
                    <!-- /.modal-content -->
                </div>
